...
public class TelegramNotificationService : INotificationService
{
    ...
    public TelegramNotificationService(ILogger<TelegramNotificationService> logger, IConfiguration configuration, HttpClient httpClient, IRedisService redisService)
    {
        ...
        _botToken = configuration["Telegram:BotToken"] ?? throw new InvalidOperationException("Telegram:BotToken not configured.");
        _chatId = configuration["Telegram:ChatId"] ?? throw new InvalidOperationException("Telegram:ChatId not configured.");
