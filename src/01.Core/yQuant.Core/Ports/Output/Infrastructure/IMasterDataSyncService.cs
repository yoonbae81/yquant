...
namespace yQuant.Core.Ports.Output.Infrastructure
{
    ...
    public interface IMasterDataSyncService
    {
        ...
        Task SyncCountryAsync(string country, Dictionary<string, string> exchangeUrls, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        Task SyncAllAsync(Dictionary<string, Dictionary<string, string>> countries, CancellationToken cancellationToken = default);
    }
}
