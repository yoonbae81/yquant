...
public class MasterDataSyncServiceTests
{
    ...
    public async Task SyncCountryAsync_WithValidData_ShouldLoadAndSaveStocks()
    {
        ...
        {
            new StockMaster { Ticker = "005930", Name = "?ºÏÑ±?ÑÏûê", Exchange = "KOSPI", Currency = CurrencyType.KRW },
            new StockMaster { Ticker = "000660", Name = "SK?òÏù¥?âÏä§", Exchange = "KOSPI", Currency = CurrencyType.KRW }
        };
