...
using yQuant.Policies.Market.HongKong;

namespace yQuant.Policies.Market.HongKong.Tests;

[TestClass]
public class HongKongMarketRuleTests
{
    private readonly HongKongMarketRule _rule = new HongKongMarketRule();
    ...
    {
        // Arrange
        // 10:00 AM HKT (UTC+8) -> 02:00 AM UTC
    ...
    {
        // Arrange
        // 02:00 PM HKT (UTC+8) -> 06:00 AM UTC
    ...
    {
        // Arrange
        // 12:30 PM HKT (UTC+8) -> 04:30 AM UTC
        var lunchTime = new DateTime(2025, 11, 25, 4, 30, 0, DateTimeKind.Utc);
    ...
    {
        // Arrange
        // 05:00 PM HKT (UTC+8) -> 09:00 AM UTC
    ...
    [TestMethod]
    public void GetCurrency_ReturnsHKD()
    {
        // Act
        var currency = _rule.GetCurrency();

        // Assert
        Assert.AreEqual(CurrencyType.HKD, currency);
    }
}
